...
public class LoadFlowController {
    ...
    public ResponseEntity<LoadFlowResult> loadFlow(@ApiParam(value = "Network UUID") @PathVariable("networkUuid") UUID networkUuid,
        ...
        LoadFlowResult result = loadFlowService.loadFlow(networkUuid, otherNetworksUuid, parameters, provider, Optional.ofNullable(reportId), Optional.ofNullable(reportName));
